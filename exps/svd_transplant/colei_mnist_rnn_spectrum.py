...
results_dir = PLAYGROUND_DIR/"seq_mnist_new_colei_rnn_spectrum_icml_rebuttal"
...
#                                                                                         params.val_batch_size)
    ...
    filestr = str(params.get_exp_savepath() / f'new_colei_rnn_spec_learning_curves_seed{seed}_lr{lr}_GC{max_gn}_rad{rad}')
...
torch.save(model.state_dict(), f'{PLAYGROUND_DIR}/saved_models/seq_mnist_rebuttal_new_colei_rnn_spec_seed{seed}_lr{lr}_GC{max_gn}_rad{rad}.pth')
