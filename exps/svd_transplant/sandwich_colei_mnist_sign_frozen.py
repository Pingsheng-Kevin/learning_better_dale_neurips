...
results_dir = PLAYGROUND_DIR/"seq_mnist_colei_sandwich_eiratio"
...
cells =[RNNCell(input_features, n_hidden, nonlinearity=F.relu, i2h_init_policy=RNN_ColumnEi_FirstCell_U_InitPolicy(dataset='MNIST'), h2h_init_policy=RNNInit_ColEI_Spectrum_Vectors(ratio=99), update_policy=SGD_Clip_UpdatePolicy(max_grad_norm=max_gn)),
        DenseLayer(n_hidden, n_output_classes, nonlinearity=None, init_policy=Dense_RNNInit_ColEI_Spectrum_Vector(ratio=99), update_policy=SGD_Clip_UpdatePolicy(max_grad_norm=max_gn))] 
